...
#define OUR_ADC_CHANNEL_2     ADC_CHANNEL_5  // GPIO6 - ANALOG_A2
#define OUR_ADC_CHANNEL_3     ADC_CHANNEL_6  // GPIO7 - ANALOG_A3
#define OUR_ADC_CHANNEL_4     ADC_CHANNEL_4  // GPIO5 - ANALOG_A4
